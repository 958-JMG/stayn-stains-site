...
const fr: Strings = {
  meta: {
    title_home: "Domaine Les Arômes — Dernier appartement à Méré (78) · Livraison dans moins d'1 an",
    desc_home:
      "Plus qu'un seul logement disponible au Domaine Les Arômes à Méré (78). Les travaux avancent, livraison dans moins d'1 an. Offre exceptionnelle : −10 000 € + frais de notaire offerts pour toute réservation avant le 30/05/2026.",
  ...
  urgency: {
    region_label: "Offre exceptionnelle",
    tag: "Plus qu'1 lot",
    remise_label: "−10 000 € + frais de notaire offerts",
    text_prefix: "Réservation avant le",
    text_count_part: () => "30/05/2026 — livraison dans moins d'1 an",
    cd_prefix: "Plus que",
    cta: "Je le réserve",
    close_aria: "Fermer le bandeau",
  },
  hero: {
    eyebrow: "Programme neuf · Méré (78) · Livraison < 1 an",
    h1_line1: "Plus qu'un seul logement.",
    h1_line2: "Les travaux avancent.",
    lead_strong: "Livraison dans moins d'1 an.",
    lead_body:
      " Trois petits bâtiments cernés de jardins paysagers, à deux pas du centre de Montfort-l'Amaury. Offre exceptionnelle sur le dernier lot : −10 000 € et frais de notaire offerts pour toute réservation avant le 30/05/2026.",
    cta_offer: "Voir l'offre",
    cta_program: "Découvrir le domaine",
    bullet_re2020: "Livraison < 1 an",
    bullet_tva: "Frais de notaire offerts",
    bullet_ptz: "−10 000 € de remise",
  },
  offer: {
    section_label: "Offre exceptionnelle",
    tag: "Plus qu'1 lot",
    title_prefix: "−10 000 €",
    title_or: "et frais de notaire offerts",
    lead_strong_first: () => "",
    lead_body: "Pour toute réservation avant le 30/05/2026, sur le tout dernier appartement disponible. Une remise complémentaire vous attend au bureau de vente.",
    table_h: "Le dernier appartement disponible",
    table_lot: "Lot",
    table_before: "Prix initial",
    table_after: "Prix avec remise",
    table_save: "Vous économisez",
    bonus_tag: "En plus de la remise",
    bonus_subtitle: "Réservez avant le 30/05/2026",
    bonus_title: "Frais de notaire offerts",
    bonus_body: "+ une remise complémentaire à découvrir directement au bureau de vente.",
    bullet1: (date) =>
      `Signez le contrat de réservation avant le ${date} pour activer l'offre.`,
    bullet2: "La remise est appliquée au prix TTC de votre logement.",
    bullet3: "Visite des travaux possible sur rendez-vous — livraison dans moins d'1 an.",
    cta_lock: "Je réserve le dernier lot",
    fine_prefix: "Voir les ",
    fine_link: "conditions complètes",
    fine_suffix: ". Offre valable sur le dernier lot du programme, jusqu'au 30/05/2026.",
  ...
  programme: {
    ...
    h2: "Les travaux avancent — livraison dans moins d'1 an.",
    f1_h: "Livraison imminente",
    f1_p:
      "Le chantier avance à grands pas. Votre appartement vous sera livré dans moins d'1 an — visite des travaux possible sur rendez-vous au bureau de vente.",
    f2_h: "Jardins paysagers & terrasses",
    f2_p:
    ...
    f3_h: "Aux portes de Montfort-l'Amaury",
    f3_p:
      "À 5 minutes du centre-bourg médiéval de Montfort, commerces et services à portée de main. Gare Méré-Montfort (ligne N) directe vers Paris Montparnasse.",
  },
  interior: {
  ...
  contact: {
    ...
    lead_body:
      "Plan de l'appartement, prix avec remise, simulation de financement et remise complémentaire à découvrir. Un conseiller vous recontacte sous ",
...
const en: Strings = {
  meta: {
    title_home: "Domaine Les Arômes — Last apartment in Méré (78) · Delivery in under 1 year",
    desc_home:
      "Only one apartment left at Domaine Les Arômes in Méré (78). Construction is advancing, delivery in less than 1 year. Exceptional offer: −€10,000 + notary fees waived for any reservation before 30 May 2026.",
  ...
  urgency: {
    region_label: "Exceptional offer",
    tag: "Only 1 unit left",
    remise_label: "−€10,000 + notary fees waived",
    text_prefix: "Reservation before",
    text_count_part: () => "30/05/2026 — delivery in under 1 year",
    cd_prefix: "Only",
    cta: "Claim it",
    close_aria: "Close the banner",
  },
  hero: {
    eyebrow: "New development · Méré (78) · Delivery < 1 year",
    h1_line1: "Only one apartment left.",
    h1_line2: "Construction is advancing.",
    lead_strong: "Delivery in less than 1 year.",
    lead_body:
      " Three small buildings surrounded by landscaped gardens, steps away from the town centre of Montfort-l'Amaury. Exceptional offer on the final unit: −€10,000 and notary fees waived for any reservation before 30 May 2026.",
    cta_offer: "See the offer",
    cta_program: "Discover the domain",
    bullet_re2020: "Delivery < 1 year",
    bullet_tva: "Notary fees waived",
    bullet_ptz: "−€10,000 discount",
  },
  offer: {
    section_label: "Exceptional offer",
    tag: "Only 1 unit left",
    title_prefix: "−€10,000",
    title_or: "and notary fees waived",
    lead_strong_first: () => "",
    lead_body: "For any reservation before 30 May 2026, on the very last apartment available. An additional discount awaits you at the sales office.",
    table_h: "The last available apartment",
    table_lot: "Unit",
    table_before: "List price",
    table_after: "Price with discount",
    table_save: "You save",
    bonus_tag: "On top of the discount",
    bonus_subtitle: "Reserve before 30/05/2026",
    bonus_title: "Notary fees waived",
    bonus_body: "+ an additional discount to discover directly at the sales office.",
    bullet1: (date) => `Sign the reservation contract before ${date} to activate the offer.`,
    bullet2: "The discount is applied to the inc. VAT price of your apartment.",
    bullet3: "Site visit possible by appointment — delivery in less than 1 year.",
    cta_lock: "Reserve the last unit",
    fine_prefix: "See the ",
    fine_link: "full conditions",
    fine_suffix: ". Offer valid on the last unit, until 30 May 2026.",
  ...
  programme: {
    ...
    h2: "Construction is advancing — delivery in less than 1 year.",
    f1_h: "Imminent delivery",
    f1_p:
      "Construction is progressing rapidly. Your apartment will be delivered in less than 1 year — site visit possible by appointment at the sales office.",
    f2_h: "Landscaped gardens & terraces",
    f2_p:
    ...
    f3_h: "At the gates of Montfort-l'Amaury",
    f3_p:
      "Five minutes from the medieval centre of Montfort, with shops and services within reach. Méré-Montfort train station (Transilien line N) goes direct to Paris Montparnasse.",
  },
  interior: {
  ...
  contact: {
    ...
    lead_body:
      "Floor plan, price with discount, financing simulation, plus the additional discount waiting for you. A consultant will get back to you within ",
